...
//    if (!mapElement) {
//        console.error("Map container 'map' not found. Make sure the element exists in the DOM.");
//        return;
//    }
...
//    map = L.map(mapElement, {  // Use the DOM element reference
...
//// Initialize routing functionality
//// Initialize routing functionality - FIXED VERSION
//function initRouting() {
//    const originInput = document.getElementById('origin');
//    const destinationInput = document.getElementById('destination');

//    // Only initialize if routing controls exist
...
//        }
//    } else {
//        console.warn("Routing controls not found. Routing functionality disabled.");
//    }
//}
//// Fetch autocomplete suggestions
//function fetchSuggestions(query, datalistId) {
...
//    // Update SignalR status badge if it exists
//    if (signalrStatusEl) {
//        if (connected) {
...
//    console.log(`SignalR connection: ${connected ? 'Connected' : 'Disconnected'}`);
//}
//// Load initial cars
//function loadInitialCars() {
//    const initialCarsDataEl = document.getElementById('initialCarsData');

//    // Safely handle missing element
//    if (!initialCarsDataEl) {
//        console.warn("initialCarsData element not found. No initial cars loaded.");
//        return;
//    }

//    try {
//        const initialCars = JSON.parse(initialCarsDataEl.textContent);
...
//            }
//        } catch (gpsError) {
//            console.error('GPS status check failed:', gpsError);
//            const gpsStatusEl = document.getElementById('gpsStatus');
//            if (gpsStatusEl) {
//                gpsStatusEl.className = 'badge bg-warning';
...
//// Initialize everything when DOM is loaded - FIXED VERSION
...
//    const showAllCarsBtn = document.getElementById('showAllCarsBtn');
//    const clearHistoryBtn = document.getElementById('clearHistoryBtn');
//    const autoRefreshCheckbox = document.getElementById('autoRefresh');

//    if (refreshBtn) {
//        refreshBtn.addEventListener('click', refreshGpsPositions);
//    }
...
//            if (map) map.setView([34.5553, 69.2075], 10);
//        });
//    }

//    if (showAllCarsBtn) {
//        showAllCarsBtn.addEventListener('click', fitMapToMarkers);
//    }

//    if (clearHistoryBtn) {
//        clearHistoryBtn.addEventListener('click', () => {
//            Object.values(carPaths).forEach(path => {
//                if (path && path.setLatLngs) path.setLatLngs([]);
//            });
